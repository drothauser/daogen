...
/**
 * Tests for {@link DaoGenRunner} that generates DbUtil DAOs using Oracle.
 * 
 * @author drothauser
 */
public class DbUtilsGenOraTest {

	/**
	 * SLF4J Logger for DbUtilsGenOraTest.
	 */
	private static final Logger LOGGER =
	    LoggerFactory.getLogger(DbUtilsGenOraTest.class);
	...
	public final void testDaoGenRunner() throws Exception {
		...
		String targetGenDir = FilenameUtils.normalize(
		    System.getProperty("user.dir") + "/../daogen-test-dbutils-ora");

		// String tables = "USERSGENERAL";
		// String tables = "APPLICATION,USERS,USERSGENERAL,GROUPS";
	...
	private String[] buildArgs(String targetGenDir, String tables, String sql,
		...
		String propsFile = "oracle/unitils.properties";
		...
		argList.add("java:/comp/env/jdbc/dv01");
